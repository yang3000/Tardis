...
namespace TARDIS::UI
{
	ImVec4 DirectX12Device::clear_color = ImVec4(0.45f, 0.55f, 0.60f, 1.00f);
	...
	void DirectX12Device::initWindow()
	{
		...
		if (!CreateDeviceD3D(m_hwnd))
		{
			CleanupDeviceD3D();
			::UnregisterClass(wc.lpszClassName, wc.hInstance);
			throw std::runtime_error("Failed to Init DirectX12");
		}
		// Show the window
	...
	// void DirectX12Device::preRender()
	// {
	...
	// void DirectX12Device::postRender()
	// {
	// 	// Rendering
	// 	ImGui::Render();
	// }

	void DirectX12Device::render()
	{
	...
	bool DirectX12Device::isRunning()
	{
		MSG msg;
