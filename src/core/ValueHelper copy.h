...
namespace TARDIS::CORE
{
	...
	public:
		...
		static inline return_type fromMemory(MemoryBuffer memory)
		{
			return ValueHelper<T>::fromMemory(memory);
		}
	...
	public:
		...
		static inline return_type fromMemory(MemoryBuffer memory)
		{
			return fromString(std::string(static_cast<const char*>(memory.buf), memory.len));
			//return *reinterpret_cast<pass_type*>(memory.buf);
		}
