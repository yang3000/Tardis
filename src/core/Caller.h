...
namespace TARDIS::CORE
{
    ...
    public:
        ...
        template <int... S>
        void call(Seq<S...>, Str *params) { assert(m_obj); assert(m_fn); return (m_obj->*m_fn)(ValueHelper<Args>::fromString(std::string(params[S].buf, params[S].len))...); }

        bool operator()(Str *params) { call(m_seq, params); return true; }
